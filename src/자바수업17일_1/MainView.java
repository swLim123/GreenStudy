...
class MainView extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnBook)        {MainViewBook mv = new MainViewBook();}
		else if(e.getSource()==btnMember) {MainMember ml = new MainMember();}
		else if(e.getSource()==btnWrite)  {Board bd = new Board();}
