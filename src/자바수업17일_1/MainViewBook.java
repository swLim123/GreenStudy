...
class MainViewBook extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnRent)      {BookRental brl = new BookRental();}
		else if(e.getSource()==btnReturn) {BookReturn br = new BookReturn();}
		else if(e.getSource()==btnBookList)  { BookRentList brl = new BookRentList();}
		else if(e.getSource()==btnRentMember) {BookRentMemberList mrm = new BookRentMemberList();}
		else if(e.getSource()==btnBookManager) { BookManager bm = new BookManager();}
