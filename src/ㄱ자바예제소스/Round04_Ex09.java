...
public class Round04_Ex09 {
	public static void main(String[] ar) throws java.io.IOException {
		...
		System.out.print("수1 : "); int su1 = Integer.parseInt(in.readLine());
		System.out.print("수2 : "); int su2 = Integer.parseInt(in.readLine());
		System.out.println("결과 : " + (su1 + su2));
		
		System.out.println("수3 : "); String Su1 = in.readLine();
		int su3 = Integer.parseInt(Su1);
		System.out.println("수4 : "); String Su2 = in.readLine();
